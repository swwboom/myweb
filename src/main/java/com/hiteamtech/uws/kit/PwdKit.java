package com.hiteamtech.uws.kit;
...
public class PwdKit{
	...
	static Logger log = Logger.getLogger(PwdKit.class);
    ...
    //PBKDF2算法迭代计数
    public static final int PBKDF2_ITERATIONS = Config.PBKDF2_ITERATIONS;
    ...
    public static boolean validatePassword(String password, String correctHash) throws NoSuchAlgorithmException, InvalidKeySpecException{
    	...
    	boolean result = validatePassword(password.toCharArray(), correctHash);
    	log.debug("密码校验耗时："+(System.currentTimeMillis() - time));
        return result;
    }
    	...
    	try {
	    	...
	    	for (int i = 0; i <1000; i++) {
                long time = System.currentTimeMillis();
	 	    	...
	 	    	log.debug("单次加密耗时："+(System.currentTimeMillis() - time));
			}
	    	log.debug("1000次密码加密总耗时："+(System.currentTimeMillis() - timecount));
